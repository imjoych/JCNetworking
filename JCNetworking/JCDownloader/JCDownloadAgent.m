...
static NSString *const JCDownloadAgentFolder = @"com.jc.jcnetworking.folder";
...
static dispatch_queue_t jc_download_agent_file_operation_queue() {
    ...
    dispatch_once(&onceToken, ^{
        download_agent_file_operation_queue = dispatch_queue_create("com.jc.jcnetworking.download.agent.file.operation", DISPATCH_QUEUE_SERIAL);
    });
